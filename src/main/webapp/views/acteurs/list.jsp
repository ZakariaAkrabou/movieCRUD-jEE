    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Liste des Acteurs</h1>
                    <p class="mt-1 text-sm text-gray-600">Gérez les acteurs de votre collection.</p>
                </div>
                <div class="flex items-center gap-4">
                    <div class="relative">
                        <input type="text" placeholder="Rechercher des acteurs..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 w-64">
                        <div class="absolute left-3 top-2.5 text-gray-400">
                            <i class="fas fa-search"></i>
                        </div>
                    </div>
                    <a href="${pageContext.request.contextPath}/views/acteurs/add.jsp" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-medium text-gray-500">Total Acteurs</h3>
                        <p class="text-2xl font-semibold"><c:out value="${acteurs.size()}"/></p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50 flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-800">Table des Acteurs</h2>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <c:choose>
                            <c:when test="${empty acteurs}">
                                <tr>
                                    <td colspan="5" class="py-6 px-4 text-center text-gray-600">Aucun acteur n'existe actuellement.</td>
                                </tr>
                            </c:when>
                            <c:otherwise>
                                <c:forEach var="acteur" items="${acteurs}">
                                    <tr class="hover:bg-gray-50 transition text-sm">
                                        <td class="py-3 px-4 border-b border-gray-200">${acteur.id}</td>
                                        <td class="py-3 px-4 border-b border-gray-200 font-medium">${acteur.nom}</td>
                                        <td class="py-3 px-4 border-b border-gray-200">${acteur.prenom}</td>
                                        ...
                                        <td class="py-3 px-4 border-b border-gray-200">
                                            <div class="flex justify-center space-x-2">
                                                <a href="${pageContext.request.contextPath}/edit-acteur?id=${acteur.id}"
                                                ...
                                                <a href="${pageContext.request.contextPath}/delete-acteur?id=${acteur.id}"
