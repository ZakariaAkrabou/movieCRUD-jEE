        ...
        <div class="mb-8">
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Fill in the details to add a new film to your collection</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50">
                <h2 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                    <i class="fas fa-plus-circle text-primary-600"></i> Film Information
                </h2>
            </div>
                ...
                <div class="border-t border-gray-200 pt-6 flex justify-between items-center">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button type="submit" 
                            ...
                            <i class="fas fa-save mr-2"></i> Save Film
                        </button>
                    </div>
                </div>
            </form>
