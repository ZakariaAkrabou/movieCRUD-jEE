    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Modifier un Réalisateur</h1>
                    <p class="mt-1 text-sm text-gray-600">Mettez à jour les détails du réalisateur.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50">
                <h2 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                    <i class="fas fa-edit text-primary-600"></i> Informations du Réalisateur
                </h2>
            </div>
            
            <form action="${pageContext.request.contextPath}/modifier-realisateur" method="post" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nom" id="nom" value="${realisateur.nom}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="prenom" id="prenom" value="${realisateur.prenom}" required
                                class="pl-10 block w-full h-10 rounded-md border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                                placeholder="Entrez le prénom du réalisateur">
                        </div>
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nationalite" id="nationalite" value="${realisateur.nationalite}" required
                                class="pl-10 block w-full h-10 rounded-md border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                                placeholder="Entrez la nationalité du réalisateur">
                        </div>
                    </div>
                </div>
