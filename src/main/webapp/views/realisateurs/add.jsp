...
<head>
    ...
    <title>Ajouter un Réalisateur | Cinema Hub</title>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Ajouter un Réalisateur</h1>
                    <p class="mt-1 text-sm text-gray-600">Remplissez les détails pour ajouter un nouveau réalisateur.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl mx-auto">
            <div class="border-b border-gray-200 px-6 py-4 bg-gray-50">
                <h2 class="text-xl font-semibold text-gray-800 flex items-center gap-2">
                    <i class="fas fa-plus-circle text-primary-600"></i> Informations du Réalisateur
                </h2>
            </div>
            
            <form action="${pageContext.request.contextPath}/ajouter-realisateur" method="post" class="p-6 space-y-6">
